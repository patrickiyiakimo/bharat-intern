  ...
  return (
    <div>
      <div className="bg-gray-900 text-center text-white font-mono ">
        ...
        <p className="pl-10 pr-10 text-xl pb-10 md:pb-14 font-semibold">
      ...
      >
        <div className=" md:grid grid-cols-3 pb-20 bg-gray-900 pr-10 pl-32 md:pl-40 font-mono">
          <div>
            ...
            <p className="text-white md:pt-3 text-sm pb-10">
              LinkedIn community
            </p>
          </div>
          <div>
            ...
            <p className="text-white md:pt-3 pb-10 text-sm ">
              Telegram community
            </p>
          </div>
          <div>
            ...
            <p className="text-white pr-10 md:pr-10 md:pt-3 text-sm ">
